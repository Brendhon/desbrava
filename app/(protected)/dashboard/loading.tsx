...
const styles = {
  ...
  header: 'flex gap-4 flex-col lg:flex-row justify-center items-center lg:justify-between',
  ...
  statCard: 'bg-slate-dark rounded-lg border border-midnight-blue/20 p-6 animate-pulse',
  ...
  tripCard: 'bg-slate-dark rounded-lg border border-midnight-blue/20 p-6 animate-pulse space-y-4',
  tripTitle: 'h-6 w-40',
  tripText: 'h-4 w-full',
