...
export default function HeroSection({ onGoogleLogin, isLoading = false }: HeroSectionProps) {
  return (
          ...
          <div className={styles.textContent}>
            ...
            <div className={styles.features}>
              <div className={styles.feature}>
                ...
                <span className={styles.featureText}>Criação de viagens simplificada</span>
              </div>
              <div className={styles.feature}>
                <span className={styles.featureIcon}>📍</span>
                <span className={styles.featureText}>Pontos de referência inteligentes</span>
              </div>
              <div className={styles.feature}>
                <span className={styles.featureIcon}>📅</span>
                <span className={styles.featureText}>Roteiros organizados por dia</span>
              </div>
              <div className={styles.feature}>
                <span className={styles.featureIcon}>🤖</span>
                <span className={styles.featureText}>Sugestões automáticas de locais</span>
              </div>
            </div>
          </div>
...
const styles = {
  ...
  title: "text-2xl md:text-3xl lg:text-4xl font-bold text-parchment-white leading-tight",
