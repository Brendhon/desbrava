...
export function ItineraryStats({
  ...
  const mostCommonType = Object.entries(activitiesByType).sort(
    ([, a], [, b]) => b - a
  )[0];
...
const styles = {
  container:
    'bg-slate-dark rounded-lg border border-slate-dark/20 p-4 sm:p-6 space-y-6',
  ...
  statIcon:
    'w-10 h-10 bg-royal-purple rounded-lg flex items-center justify-center',
