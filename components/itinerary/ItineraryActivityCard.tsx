...
const styles = {
  ...
  placeInfo: 'flex items-start gap-3',
  ...
  websiteLink: 'p-1 text-mist-gray hover:text-royal-purple transition-colors',
  websiteIcon: 'w-4 h-4',
  footer: 'flex items-center gap-6 text-sm text-mist-gray',
